...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Edit Penolakan Audit</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('audit.reject.view') }}">Audit Reject</a></li>
                    <li class="breadcrumb-item active">Edit Penolakan Audit</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('audit.reject.update', $audit->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="reject_reason" class="form-control @error('reject_reason') is-invalid @enderror" id="reject_reason" required>{{ old('reject_reason', $audit->reject_reason) }}</textarea>
                        @error('reject_reason')
                    ...
                    <a href="{{ route('audit.reject.view') }}" class="btn btn-secondary">Kembali</a>
