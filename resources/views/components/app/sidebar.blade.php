            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('dokumen.type.index', 'kebijakan') }}" class="nav-link {{ request()->is('dokumen/kebijakan*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Kebijakan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('dokumen.type.index', 'standar') }}" class="nav-link {{ request()->is('dokumen/standar*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Standar</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('dokumen.type.index', 'manual') }}" class="nav-link {{ request()->is('dokumen/manual*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Manual</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('dokumen.type.index', 'formulir') }}" class="nav-link {{ request()->is('dokumen/formulir*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Formulir</p>
                            </a>
                        </li>
